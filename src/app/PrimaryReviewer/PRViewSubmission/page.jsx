...
function PRViewSubmission({ params }) {
  ...
  return (
    <div className="adminpage-container">
          ...
          <div className="pr-header-container-mobile">
            ...
            <a href="../PrimaryReviewer/PRSubmissions" className="back-button">
              ...
              <Col xs={12} lg={4} className="viewsub-details-container">
                ...
                <div className="viewsub-finalrec" onClick={handleShowFinalReviewModal}>
      ...
      <FinalReviewModal show={modalShowFinalReview} onHide={handleCloseFinalReviewModal} />
    </div>
  );
}

export default withAuthorization(PRViewSubmission, "PrimaryReviewer");