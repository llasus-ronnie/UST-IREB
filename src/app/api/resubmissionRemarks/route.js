...
export async function POST(req) {
  try {
    ...
    const savedResubmission = await ResubmissionRemarksModel.create(
      newResubmission
    );
...
export async function GET(req) {
  try {
    ...
    const getResubmissionRemarks = await ResubmissionRemarksModel.find({
      subFormId,
    });
