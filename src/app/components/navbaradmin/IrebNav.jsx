  ...
  return (
    <div className={`irebnav adminnav ${isOpen ? "open" : ""}`}>
      ...
      <div className="adminnav-content">
        <ul>
          <li className={`adminnavline ${isActive === "profile" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBUserProfile" onClick={() => isActive("profile")}>
              <div>
                <svg
                  fill="#a58324"
                  width="30"
          ...
          <li className={`adminnavline ${isActive === "home" ? "active-linkline" : ""}`}>
          ...
          {/* Manage Accounts */}
          <li className={`dropdown adminnavline ${isActive === "accounts" ? "active-linkline" : ""}`}>
            <div className="dropdown-div">
              <div onClick={handleImageClick}>
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`${isActive === "accounts" ? "active-link-accounts" : ""}`}  
                >
                  <path
            ...
            {isDropdownOpen && isOpen && (
              <ul className="adminnav-dropdown">
                <li>
                  <a href={href} legacyBehavior onClick={() => isActive("accounts")}>
                    <a>
                ...
                <li>
                  <a href={hrefExternal} legacyBehavior onClick={() => isActive("accounts")}>
                    <a>
          ...
          <li className={`adminnavline ${isActive === "content" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBManageContent" onClick={() => isActive("content")}>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
          ...
          <li className={`adminnavline ${isActive === "reports" ? "active-linkline" : ""}`}>
