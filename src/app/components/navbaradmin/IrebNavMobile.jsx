    ...
    <div className={`adminnav ${isNavVisible ? "visible" : "hidden"}`}>
      <div className="adminnav-content">
        ...
        <li className={`${isActive === "profile" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBUserProfile" passHref>
              <div>
                <svg
                  fill="#a58324"
                  width="30"
          ...
          <li className={`${isActive === "home" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBDashboard" passHref >
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
          ...
          <li className={`${isActive === "content" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBManageContent" passHref>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
          ...
          <li className={`${isActive === "reports" ? "active-linkline" : ""}`}>
            <a href="../IREB/IREBReports" passHref>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30"
      ...
      >
        ...
        <a href="../IREB/IREBManageREC" passHref>
          <p>Manage REC Accounts</p>
        </a>
        <a href="../IREB/IREBManageExternal" passHref>
