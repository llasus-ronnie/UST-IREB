      ...
      <div className="adminnav-content">
        <ul>
          ...
          <li>
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#fcbf15" className="bi bi-house-door" viewBox="0 0 16 16">
          ...
          <li>
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#fcbf15" className="bi bi-pencil-square" viewBox="0 0 16 16">
          ...
          <li>
            ...
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#fcbf15" className="bi bi-folder2" viewBox="0 0 16 16">
