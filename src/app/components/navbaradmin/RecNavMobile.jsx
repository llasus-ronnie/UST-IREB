...
=======
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" className="bi bi-person-circle" viewBox="0 0 16 16">
                  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                  <path fillRule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
                </svg>
>>>>>>> 6de237a9ac6061a184fe0b79026dae68f50782cf
                <p>Profile</p>
              </div>
            </Link>
          </li>
          ...
          <li>
            <Link href={`../REC/RECSubmissions/${params}` } passHref>
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" className="bi bi-clipboard-check" viewBox="0 0 16 16">
          ...
          <li>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" className="bi bi-pencil-square" viewBox="0 0 16 16">
          ...
          <li>
            <Link href="/reports" passHref>
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" className="bi bi-folder2" viewBox="0 0 16 16">
          ...
          <li>
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none">
                <path d="M21 12L13 12" stroke="#fcbf15" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M18 15L20.913 12.087V12.087C20.961 12.039 20.961 11.961 20.913 11.913V11.913L18 9" stroke="#fcbf15" strokeWidth= "2" strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M16 5V4.5V4.5C16 3.67157 15.3284 3 14.5 3H5C3.89543 3 3 3.89543 3 5V19C3 20.1046 3.89543 21 5 21H14.5C15.3284 21 16 20.3284 16 19.5V19.5V19" stroke="#fcbf15" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
                <p>Log Out</p>
              </div>
            </Link>
