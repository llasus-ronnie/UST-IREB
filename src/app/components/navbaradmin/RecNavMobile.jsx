      ...
      <div className="adminnav-content">
        <ul>
          <li>
            <Link href="../" passHref>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" class="bi bi-person-circle" viewBox="0 0 16 16">
          ...
          <li>
            <Link href="../REC/RECdashboard/" passHref>
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" class="bi bi-house-door" viewBox="0 0 16 16">
          ...
          <li>
            <Link href={`../REC/RECSubmissions/${params}` } passHref>
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" class="bi bi-clipboard-check" viewBox="0 0 16 16">
          ...
          <li>
            <Link href="/reports" passHref>
              <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fcbf15" class="bi bi-folder2" viewBox="0 0 16 16">
