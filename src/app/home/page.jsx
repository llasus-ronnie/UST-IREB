            ...
            <Row className="row-alignment">
              ...
              <Col>
                ...
                <p>
                  ...
                  principal investigator is outside UST, they must request an
                  account from IREB by submitting a letter of intent. Once
                  endorsed, IREB will provide a unique token to access the
                  portal. Click here to learn more about creating an account.
                </p>
                ...
                <p>
                  ...
                  investigator must complete the online forms and upload all the
                  required documents in PDF format.
                </p>

                <p>
                  4. The REC evaluates the submitted requirements. If the
                  requirements meet REC standards, the principal investigator
                  must process the payment fee for the chosen REC and submit
                  proof of payment.
                </p>

                <p>
                  5. The submission will then be classified as expedited,
                  exempt, or subject to a full board review, depending on the
                  nature of the research. If the submission undergoes a full
                  board or expedited review, the REC designates a primary
                  reviewer to assess the content of the research paper.
                </p>

                <p>
                  6. If revisions are requested by the primary reviewer, the
                  principal investigator must resubmit the necessary revisions
                  in the portal. If they wish to appeal the requested revision,
                  they can do so using the designated comment section in the
                  resubmission.
                </p>

                <p>
                  7. The principal investigator has 1-3 weeks to make revisions.
                  If no resubmissions are received after 1 month, the research
                  submission will be marked as deferred.
                </p>
                ...
                <p>
                  ...
                  certificate of ethics review. If disapproved, they receive a
                  letter of disapproval. If the research is classified as
                  exempt, a certification of exemption from ethical review is
                  issued.
                </p>
              </Col>
